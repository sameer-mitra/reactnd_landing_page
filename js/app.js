...
function scrollFunction() {
  ...
  navItems.forEach(({elementSection, elementNavLink, elementNavItem}) => {
    ...
    let hero_section = document.getElementById('hero');
    let topHeight = navbarHeight + hero_section.offsetHeight;
    if (
      (elementSection.offsetTop - window.pageYOffset < topHeight)
      &&
      (elementSection.offsetTop + elementSection.offsetHeight - window.pageYOffset > topHeight)
    ) {
...
function topFunction() {
  document.body.scrollTop = navbarHeight; // For Safari
  document.documentElement.scrollTop = navbarHeight; // For Chrome, Firefox, IE and Opera
}
